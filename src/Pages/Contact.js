...
function Contact() {
  ...
  return (
    <main className="container mx-auto max-width section" id="contact">
      <h1 className="text-center text-xl md:text-3xl lg:text-6xl text-dark-heading dark:text-light-heading font-semibold md:font-bold">
